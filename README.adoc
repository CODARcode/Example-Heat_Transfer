...
** http://swift-lang.github.io/swift-t/guide.html#Build_configuration
** http://swift-lang.github.io/swift-t/guide.html#_from_source or
. Install MPIX_Launch module: +
Follow directions here:
+
