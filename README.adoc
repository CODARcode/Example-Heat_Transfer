...
[.lead]
This example shows how to run the heat transfer ADIOS pipeline from Swift. This application works as shown in the figure [TBD]. 
...
* The uncompressed and compressed results are written to two files, `heat.bp` and `staged.bp`, respectively.
