...
perl ./chaos_build.pl
----
NOTE: bison, flex, perl and cmake (version > 2.8.3) is required. You may want to install with spack
+
----
spack install bison flex perl cmake
spack load bison flex perl cmake
----
. Install ADIOS
+
----
